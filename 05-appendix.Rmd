...
![Mantel correlogram \label{app-2-1}](figure/AppFig2_1.png){height=40% width=40%}
...
![Pre-treatment species abundances \label{app-2-2}](figure/AppFig2_2.png){height=50% width=50%}
...
![Effects of spatial distribution \label{app-2-5}](figure/AppFig2_5.png){height=70% width=70%}
...
![MCLA PERMANOVA \label{app-2-3}](figure/AppFig2_3.png){height=80% width=80%}
...
![SFREC PERMANOVA \label{app-2-4}](figure/AppFig2_4.png){height=80% width=80%}
