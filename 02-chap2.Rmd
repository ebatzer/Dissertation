...
```
![\label{fig-2-1}](figure/Fig2_1.png){width=30%}
...
```
![\label{fig-2-3}](figure/Fig2_3.png){height=40%}

```{r, results = "hide"}
fig_nums_chap02(name = "fig-2-4")
```
![\label{fig-2-4}](figure/Fig2_4.png){height=40%}

```{r, results = "hide"}
fig_nums_chap02(name = "fig-2-5")
```
![\label{fig-2-5}](figure/Fig2_5.png){height=40%}

```{r, results = "hide"}
fig_nums_chap02(name = "fig-2-6")
```
![\label{fig-2-6}](figure/Fig2_6.png){height=40%}