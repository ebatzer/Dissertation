...
While species may exhibit varied tolerances to conditions imposed by heatwaves, droughts, and extreme cold, climate-driven changes in species relative abundances are also constrained by local interactions that govern community assembly [@Fukami2015a; @Tylianakis2008].
...
In grassland systems, clustering algorithms have shown promise in tests of expert models and in the tracking of community responses to variable grazing regimes and species invasions (e.g. @Bagchi2012; @Jackson2002a; @Stein2016; @Stringham2003) However, there appear to be few tests of their application to climate-driven vegetation turnover.
...
Community analyses were performed using “vegan” [@Oksanen2019].
...
SPEI calculations were performed with the “SPEI” package [@Beguirea2017].
